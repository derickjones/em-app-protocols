...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-[#0A0A0A] text-gray-900 dark:text-gray-100 font-body">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h1 className="text-3xl font-bold mt-6 mb-2 font-title">About EM Protocols</h1>
        ...
        <section className="mb-10">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="border border-gray-200 dark:border-[#2A2A2A] rounded-xl p-4 flex gap-3">
              <FileText className="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="text-sm font-semibold">Protocol Ingestion</h3>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Hospitals upload their protocols as PDFs. We extract all text, images, flowcharts, and algorithms automatically.</p>
              </div>
            </div>
            <div className="border border-gray-200 dark:border-[#2A2A2A] rounded-xl p-4 flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Google Vertex AI indexes everything. When you ask a question, the most relevant content is retrieved in milliseconds.</p>
              </div>
            </div>
            <div className="border border-gray-200 dark:border-[#2A2A2A] rounded-xl p-4 flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Gemini 2.0 Flash synthesizes a concise, cited answer from the retrieved content — streamed to you in real time.</p>
              </div>
            </div>
            <div className="border border-gray-200 dark:border-[#2A2A2A] rounded-xl p-4 flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Flowcharts, algorithms, and protocol diagrams are displayed prominently alongside every answer, with clickable PDF citations.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            <div className="border border-gray-200 dark:border-[#2A2A2A] rounded-xl p-5 flex gap-4 items-start">
              <Users className="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="text-sm font-semibold">Jake Morey, MD, MBA</h3>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Co-Founder</p>
              </div>
            </div>
            <div className="border border-gray-200 dark:border-[#2A2A2A] rounded-xl p-5 flex gap-4 items-start">
              <Users className="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" />
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Co-Founder &amp; Technical Lead</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* Version */}
        <div className="border-t border-gray-200 dark:border-[#2A2A2A] pt-6 text-xs text-gray-400">
