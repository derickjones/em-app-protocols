#!/usr/bin/env python3
"""
Simple Document AI test using REST API
Avoids gRPC/DNS issues by using HTTP requests
"""
...
def process_pdf(pdf_path):
    """Process PDF using Document AI REST API"""
    print(f"\n📄 Processing: {pdf_path}")
...
def main():
    print("="*60)
    print("  Document AI POC - Day 1 Test (REST API)")
